...
5. L'interface utilise `cloudflare-config.js` avec `apiBase: '/api'`. Aucun secret n'est mis dans le navigateur : les mots de passe sont haches dans le Worker et les sessions sont stockees dans D1.
